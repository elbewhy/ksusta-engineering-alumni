...
<style>
	...
	nav#sidebar{
		...
		background: url(assets/img/1602214440_photo-1533158326339-7f3cf2404354.jpg) !important;
...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
			...
			<!--	<a href="index.php?page=deans" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Deans</a>-->
